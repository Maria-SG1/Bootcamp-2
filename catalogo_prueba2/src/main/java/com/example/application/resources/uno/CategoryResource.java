...
public class CategoryResource {
	...
	@GetMapping(path = "/{id}")
	public Category getOne(@PathVariable int id) throws ItemNotFoundException {
	...
	@Transactional
	public List<FilmShortDTO> getPelis(@PathVariable int id) throws ItemNotFoundException {
		var Category = srv.getOne(id);
		if(Category.isEmpty())
			throw new ItemNotFoundException();
		else {
	...
	@PutMapping("/{id}")
	public Category update(@PathVariable int id, @Valid @RequestBody Category item) throws BadRequestException, ItemNotFoundException, InvalidDataException {
		if(item == null)
			throw new BadRequestException("Faltan los datos");
