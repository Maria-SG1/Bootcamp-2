package com.example.application.resources.uno;
...
import com.example.domains.entities.dto.ActorShort;
...
public class ActorResource {
	...
	@Transactional
	public List<Peli> getPelis(@PathVariable int id) throws ItemNotFoundException {
		var item = srv.getOne(id);
		if(item.isEmpty())
			throw new ItemNotFoundException();
	...
	public void jubilar(@PathVariable int id) throws ItemNotFoundException {
		var item = srv.getOne(id);
		if(item.isEmpty())
			throw new ItemNotFoundException();
		item.get().jubilate();
	...
	public void update(@PathVariable int id, @Valid @RequestBody ActorDTO item) throws ItemNotFoundException, InvalidDataException, BadRequestException {
