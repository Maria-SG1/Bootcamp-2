...
public class FilmEditDTO {
	...
	private List<Integer> categories = new ArrayList<>();
 	...
 	public static FilmEditDTO from(Film source) {
		return new FilmEditDTO(
				...
				source.getTitle(),
				source.getLanguage2() == null ? null : source.getLanguage2().getLanguageId(),
	...
	public static Film from(FilmEditDTO source) {
		Film rslt = new Film(
				...
				source.getReplacementCost(),
				source.getTitle(),
				source.getLanguage2Id() == null ? null : new Language(source.getLanguage2Id()),
